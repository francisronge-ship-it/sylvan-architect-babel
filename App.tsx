...
const App: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    let complexity = 'Low';
    if (maxDepth > 8) complexity = 'High-Density';
    else if (maxDepth > 5) complexity = 'Moderate';
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden selection:bg-emerald-500 selection:text-white">
      ...
      <main className="flex-1 relative flex flex-col overflow-hidden">
          ...
          {loading && (
            <div className="absolute inset-0 z-50 bg-[#020806]/95 backdrop-blur-3xl flex flex-col items-center justify-center gap-8 animate-in fade-in duration-700">
              ...
              <div className="text-center">
                ...
                <p className="text-emerald-500/40 font-black uppercase text-[9px] tracking-[0.7em]">Deep Parsing X-Bar Structures</p>
              </div>
            </div>
          )}

          {result && (activeTab === 'tree' || activeTab === 'growth') ? (
            <TreeVisualizer data={result.tree} animated={activeTab === 'growth'} />
            ...
            <div className="w-full h-full flex items-center justify-center p-12 overflow-y-auto bg-[#020806]/60 backdrop-blur-md animate-in fade-in duration-500">
              ...
              {activeTab === 'notes' && (
                <div className="max-w-3xl glass-dark p-12 rounded-[3rem] shadow-2xl animate-in slide-in-from-bottom-8">
                   <div className="flex items-center gap-5 mb-8">
                      <div className="w-12 h-12 moss-gradient rounded-2xl flex items-center justify-center text-white shadow-lg">
                        <Info size={24} />
                      </div>
                      <h2 className="text-3xl font-bold text-white serif tracking-tight">Structural Geneology</h2>
                    </div>
        ...
        {/* Input UI */}
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-30 w-full max-w-3xl px-8">
              ...
              <form onSubmit={handleParse} className="flex gap-4 items-end">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    placeholder="Plant a linguistic seed..."
                    value={input}
